# Tcl script to run LVS on LIF_comp
...
set circuit1 [readnet spice LIF_comp_layout.spice]
set circuit2 [readnet spice $sclib]

readnet spice LIF_comp.spice $circuit2

lvs "$circuit1 LIF_comp" "$circuit2 LIF_comp"         $setupfile LIF_comp_comp.out

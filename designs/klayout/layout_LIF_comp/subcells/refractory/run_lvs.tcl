# Tcl script to run LVS on refractory
...
set circuit1 [readnet spice refractory_layout.spice]
set circuit2 [readnet spice $sclib]

readnet spice refractory.spice $circuit2

lvs "$circuit1 refractory" "$circuit2 refractory"         $setupfile refractory_comp.out

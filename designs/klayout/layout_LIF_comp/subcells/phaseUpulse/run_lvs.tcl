# Tcl script to run LVS on phaseUpulse
...
set circuit1 [readnet spice phaseUpulse_layout.spice]
set circuit2 [readnet spice $sclib]

readnet spice phaseUpulse.spice $circuit2

lvs "$circuit1 phaseUpulse" "$circuit2 phaseUpulse"         $setupfile phaseUpulse_comp.out

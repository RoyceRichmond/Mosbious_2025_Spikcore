# Tcl script to run LVS on nvdiv
...
set circuit1 [readnet spice nvdiv_layout.spice]
set circuit2 [readnet spice $sclib]

readnet spice nvdiv.spice $circuit2

lvs "$circuit1 nvdiv" "$circuit2 nvdiv"         $setupfile nvdiv_comp.out

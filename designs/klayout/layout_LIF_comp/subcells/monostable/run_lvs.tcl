# Tcl script to run LVS on monostable
...
set circuit1 [readnet spice monostable_layout.spice]
set circuit2 [readnet spice $sclib]

readnet spice monostable.spice $circuit2

lvs "$circuit1 monostable" "$circuit2 monostable"         $setupfile monostable_comp.out

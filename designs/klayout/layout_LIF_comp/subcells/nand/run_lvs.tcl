...
set circuit1 [readnet spice nand_layout.spice]
set circuit2 [readnet spice $sclib]

readnet spice nand.spice $circuit2

lvs "$circuit1 nand" "$circuit2 nand"         $setupfile nand_comp.out

...
set circuit1 [readnet spice not_layout.spice]
set circuit2 [readnet spice $sclib]

readnet spice not.spice $circuit2

lvs "$circuit1 not" "$circuit2 not"         $setupfile not_comp.out

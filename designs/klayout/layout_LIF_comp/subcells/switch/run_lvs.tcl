# Tcl script to run LVS on switch
...
set circuit1 [readnet spice switch_layout.spice]
set circuit2 [readnet spice $sclib]

readnet spice switch.spice $circuit2

lvs "$circuit1 switch" "$circuit2 switch"         $setupfile switch_comp.out

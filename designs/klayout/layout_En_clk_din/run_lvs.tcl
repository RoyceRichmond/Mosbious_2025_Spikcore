# Tcl script to run LVS on En_clk_din
...
set circuit1 [readnet spice En_clk_din_layout.spice]
set circuit2 [readnet spice $sclib]

readnet spice En_clk_din.spice $circuit2

lvs "$circuit1 En_clk_din" "$circuit2 En_clk_din"         $setupfile En_clk_din_comp.out

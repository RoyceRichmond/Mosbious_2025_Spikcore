# Tcl script to run LVS on swmatrix_Tgate
...
set circuit1 [readnet spice swmatrix_Tgate_layout.spice]
set circuit2 [readnet spice $sclib]

readnet spice swmatrix_Tgate.spice $circuit2

lvs "$circuit1 swmatrix_Tgate" "$circuit2 swmatrix_Tgate"         $setupfile swmatrix_Tgate_comp.out

# Tcl script to run LVS on schmitt_trigger
...
set circuit1 [readnet spice schmitt_trigger_layout.spice]
set circuit2 [readnet spice $sclib]

readnet spice schmitt_trigger.spice $circuit2

lvs "$circuit1 schmitt_trigger" "$circuit2 schmitt_trigger"         $setupfile schmitt_trigger_comp.out

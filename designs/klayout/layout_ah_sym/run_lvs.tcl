# Tcl script to run LVS on ah_sym
...
set circuit1 [readnet spice ah_sym_layout.spice]
set circuit2 [readnet spice $sclib]

readnet spice ah_sym.spice $circuit2

lvs "$circuit1 ah_sym" "$circuit2 ah_sym"         $setupfile ah_sym_comp.out

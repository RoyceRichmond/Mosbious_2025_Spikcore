...
set circuit1 [readnet spice top_layout.spice]
set circuit2 [readnet spice $sclib]

readnet spice top.spice $circuit2

lvs "$circuit1 top" "$circuit2 top"         $setupfile top_comp.out

# Tcl script to run LVS on LIF_ring
...
set circuit1 [readnet spice LIF_ring_layout.spice]
set circuit2 [readnet spice $sclib]

readnet spice LIF_ring.spice $circuit2

lvs "$circuit1 LIF_ring" "$circuit2 LIF_ring"         $setupfile LIF_ring_comp.out

...
C {lab_pin.sym} 420 -1050 0 1 {name=p49 sig_type=std_logic lab=vout}
...
device=resistor
m=1}
C {lab_pin.sym} 280 -890 0 0 {name=p1 sig_type=std_logic lab=vin_pex}
C {lab_pin.sym} 280 -870 0 0 {name=p2 sig_type=std_logic lab=v_rew}
C {lab_pin.sym} 350 -950 0 0 {name=p3 sig_type=std_logic lab=vdd}

...
device=resistor
m=1}
C {lab_pin.sym} -470 -570 0 0 {name=p3 sig_type=std_logic lab=nclk}
...
C {designs/libs/gf180mcu_fd_sc_mcu9t5v0_symbols/inv_1.sym} -470 -530 3 0 {name=x5 VGND=VSSd VNB=VDDd VPB=VSSd VPWR=VDDd prefix=gf180mcu_fd_sc_mcu9t5v0__ }

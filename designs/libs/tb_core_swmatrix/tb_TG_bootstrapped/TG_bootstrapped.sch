...
N -470 -510 -290 -510 {lab=#net3}
N -470 -510 -470 -330 {lab=#net3}
...
device=resistor
m=1}
C {lab_pin.sym} 10 -490 2 0 {name=p3 sig_type=std_logic lab=nclk}
...
C {lab_pin.sym} 10 -510 2 0 {name=p10 sig_type=std_logic lab=clk}
...
C {designs/libs/switch_matrix_gf180mcu_9t5v0/NO_ClkGen/NO_ClkGen.sym} -140 -500 0 0 {name=x4}
C {lab_pin.sym} -290 -460 0 0 {name=p12 sig_type=std_logic lab=vdd}
C {gnd.sym} -290 -440 0 0 {name=l6 lab=GND}

...
N 80 -30 80 0 {lab=vss}
N 60 0 80 0 {lab=vss}
N 60 0 60 20 {lab=vss}
...
C {lab_pin.sym} 60 20 2 0 {name=p16 sig_type=std_logic lab=vss}
C {iopin.sym} 30 -260 2 0 {name=p3 lab=vdd}
C {lab_pin.sym} 50 -260 2 0 {name=p5 sig_type=std_logic lab=vdd}
C {iopin.sym} 50 100 2 0 {name=p1 lab=vss}
C {lab_pin.sym} 70 100 2 0 {name=p4 sig_type=std_logic lab=vss}
...
C {lab_pin.sym} -90 20 2 0 {name=p7 sig_type=std_logic lab=vss}

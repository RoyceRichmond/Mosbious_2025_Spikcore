...
S {}
E {}
B 2 880 -800 1390 -490 {flags=graph
y1=-1.6
y2=2
ypos1=0
ypos2=2
...
.control
    tran 10m 1000u
    write tb_ota_1stage_integrator.raw
.endc
.save all
"
spice_ignore=False}
...
C {launcher.sym} 1010 -440 0 0 {name=h5
descr="load waves" 
tclcommand="xschem raw_read $netlist_dir/tb_ota_1stage_integrator.raw tran"
}

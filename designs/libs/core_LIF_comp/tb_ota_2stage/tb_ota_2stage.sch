...
N 610 -240 740 -240 {lab=#net1}
N 740 -240 740 -160 {lab=#net1}
N 710 -160 740 -160 {lab=#net1}
N 560 -130 680 -130 {lab=GND}
N 680 -130 680 -90 {lab=GND}
N 680 -90 710 -90 {lab=GND}
N 710 -100 710 -90 {lab=GND}
N 390 -290 390 -270 {lab=vdd}
N 390 -290 560 -290 {lab=vdd}
N 560 -290 560 -280 {lab=vdd}
N 390 -240 410 -240 {lab=GND}
N 410 -240 410 -130 {lab=GND}
N 410 -130 560 -140 {lab=GND}
N 390 -210 540 -200 {lab=#net2}
N 350 -290 350 -240 {lab=vdd}
N 350 -290 390 -290 {lab=vdd}
...
C {symbols/cap_mim_2f0fF.sym} 710 -130 0 0 {name=C2
W=1e-6
L=1e-6
model=cap_mim_2f0fF
spiceprefix=X
m=1}
C {symbols/nfet_03v3.sym} 370 -240 0 0 {name=M1
L=0.28u
W=0.22u
nf=1
m=1

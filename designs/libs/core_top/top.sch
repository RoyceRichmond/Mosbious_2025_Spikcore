...
T {TG control pin} -500 -470 0 0 0.3 0.3 {}
T {Mosbius pins} -500 -400 0 0 0.3 0.3 {}
N 900 120 920 120 {lab=VOUT_LIF}
N 900 280 920 280 {lab=VOUT_LIF}
N 1090 120 1090 190 {lab=VOUT_LIF}
N 920 120 1090 120 {lab=VOUT_LIF}
N 920 280 1090 280 {lab=VOUT_LIF}
N 1090 190 1090 280 {lab=VOUT_LIF}
C {designs/libs/core_LIF_ring/LIF_ring.sym} 870 190 0 0 {name=x4}
...
C {lab_pin.sym} 1090 190 2 0 {name=p59 sig_type=std_logic lab=VOUT_LIF}
...
C {designs/libs/core_synapse/synapse.sym} 470 540 0 0 {name=x7}
C {designs/libs/core_synapse/synapse.sym} 470 740 0 0 {name=x8}
C {designs/libs/core_synapse/synapse.sym} 470 930 0 0 {name=x9}
C {lab_pin.sym} 500 270 0 0 {name=p70 sig_type=std_logic lab=VDD3V3}
C {lab_pin.sym} 500 470 0 0 {name=p71 sig_type=std_logic lab=VDD3V3}
C {lab_pin.sym} 500 660 0 0 {name=p72 sig_type=std_logic lab=VDD3V3}
C {lab_pin.sym} 500 420 0 0 {name=p73 sig_type=std_logic lab=VSS}
C {lab_pin.sym} 500 620 0 0 {name=p74 sig_type=std_logic lab=VSS}
C {lab_pin.sym} 500 810 0 0 {name=p75 sig_type=std_logic lab=VSS}
C {lab_pin.sym} 390 370 2 1 {name=p76 sig_type=std_logic lab=V_INH}
C {lab_pin.sym} 390 350 2 1 {name=p77 sig_type=std_logic lab=VIN_S3}
C {lab_pin.sym} 390 390 2 1 {name=p78 sig_type=std_logic lab=V_EX}
C {lab_pin.sym} 600 350 0 1 {name=p79 sig_type=std_logic lab=VOUT_S3}
C {lab_pin.sym} 390 570 2 1 {name=p80 sig_type=std_logic lab=V_INH}
C {lab_pin.sym} 390 550 2 1 {name=p81 sig_type=std_logic lab=VIN_S4}
C {lab_pin.sym} 390 590 2 1 {name=p82 sig_type=std_logic lab=V_EX}
C {lab_pin.sym} 600 550 0 1 {name=p83 sig_type=std_logic lab=VOUT_S4}
C {lab_pin.sym} 390 760 2 1 {name=p84 sig_type=std_logic lab=V_INH}
C {lab_pin.sym} 390 740 2 1 {name=p85 sig_type=std_logic lab=VIN_S5}
C {lab_pin.sym} 390 780 2 1 {name=p86 sig_type=std_logic lab=V_EX}
C {lab_pin.sym} 600 740 0 1 {name=p87 sig_type=std_logic lab=VOUT_S5}
...
C {lab_pin.sym} 760 110 0 0 {name=p95 sig_type=std_logic lab=VIN_LIF}
C {lab_pin.sym} 780 290 0 0 {name=p98 sig_type=std_logic lab=VIN_LIF}
C {lab_pin.sym} 760 130 3 0 {name=p7 sig_type=std_logic lab=VSS}
